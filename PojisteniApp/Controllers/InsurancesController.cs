...
namespace PojisteniApp.Controllers
{
    public class InsurancesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InsuranceId,InsuranceAmount,InsuranceSubject,ValidFrom,ValidTo")] Insurance insurance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InsuranceId,InsuranceAmount,InsuranceSubject,ValidFrom,ValidTo")] Insurance insurance)
        {
